...
export type LaunchDetailsQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'details' | 'id' | 'mission_name' | 'launch_year' | 'launch_success' | 'upcoming'>
    & { rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
...
export type LaunchesDataQueryVariables = Exact<{ [key: string]: never; }>;


export type LaunchesDataQuery = (
  { __typename?: 'Query' }
...
export const LaunchesDataDocument = gql`
    query launchesData {
...
/**
 * __useLaunchesDataQuery__
 *
 * To run a query within a React component, call `useLaunchesDataQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchesDataQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useLaunchesDataQuery(baseOptions?: Apollo.QueryHookOptions<LaunchesDataQuery, LaunchesDataQueryVariables>) {
        return Apollo.useQuery<LaunchesDataQuery, LaunchesDataQueryVariables>(LaunchesDataDocument, baseOptions);
      }
export function useLaunchesDataLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchesDataQuery, LaunchesDataQueryVariables>) {
          return Apollo.useLazyQuery<LaunchesDataQuery, LaunchesDataQueryVariables>(LaunchesDataDocument, baseOptions);
        }
export type LaunchesDataQueryHookResult = ReturnType<typeof useLaunchesDataQuery>;
export type LaunchesDataLazyQueryHookResult = ReturnType<typeof useLaunchesDataLazyQuery>;
export type LaunchesDataQueryResult = Apollo.QueryResult<LaunchesDataQuery, LaunchesDataQueryVariables>;